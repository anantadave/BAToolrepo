...
RunConfiguration.setExecutionSettingFile('C:\\Users\\ANANTA~1.DAV\\AppData\\Local\\Temp\\Katalon\\Test Cases\\CreateItemFB\\20181206_122114\\execution.properties')
...
not_run: WebUI.click(findTestObject('Page_Bulk Authoring Tool/button_Close'))

not_run: WebUI.switchToWindowTitle('Bulk Authoring Tool')

not_run: WebUI.click(findTestObject('Page_Bulk Authoring Tool/a_Item list'))

not_run: WebUI.setText(findTestObject('Page_Bulk Authoring Tool/input_Toggle Dropdown_form-con'), 'FB Automation added1')
